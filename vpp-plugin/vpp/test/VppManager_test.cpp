...
BOOST_FIXTURE_TEST_CASE(endpoint_group_add_del, VppManagerFixture) {
     ...
     */
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.44.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("2001:db8::"), 32}));
    ...
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.44.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.45.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("2001:db8::"), 32}));
    ...
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.44.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.45.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("10.20.46.0"), 24}));
    WAIT_FOR_MATCH(gbp_subnet(v_rd, {address::from_string("2001:db8::"), 32}));
    ...
    WAIT_FOR_NOT_PRESENT(gbp_subnet(v_rd, {address::from_string("10.20.44.0"), 24}));
    WAIT_FOR_NOT_PRESENT(gbp_subnet(v_rd, {address::from_string("10.20.45.0"), 24}));
    WAIT_FOR_NOT_PRESENT(gbp_subnet(v_rd, {address::from_string("10.20.46.0"), 24}));
    WAIT_FOR_NOT_PRESENT(gbp_subnet(v_rd, {address::from_string("2001:db8::"), 32}));
...
BOOST_FIXTURE_TEST_CASE(endpoint_add_del, VppManagerFixture) {
    ...
    for (auto& ipAddr : getEPIps(ep0)) {
        ...
        WAIT_FOR_MATCH(neighbour(*v_bvi_epg0, ipAddr, v_mac_ep0));
        WAIT_FOR_MATCH(gbp_endpoint(*v_itf_ep0, ipAddr, v_mac_ep0, *v_epg0));
    ...
    for (auto& ipAddr : getEPIps(ep2)) {
        ...
        WAIT_FOR_MATCH(gbp_endpoint(*v_itf_ep2, ipAddr, v_mac_ep2, *v_epg1));
    }
    for (auto& ipAddr : getEPIps(ep0)) {
        WAIT_FOR_MATCH(route::ip_route(v_rd, {ipAddr}, {ipAddr, *v_bvi_epg0}));
    }
